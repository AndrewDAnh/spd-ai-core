...
def main():
    ...
    reference_engines = list(range(1, 30))
    current_engines = list(range(1, 30))

    # print(f"  ✓ Reference: Engines 1-50 ({len(reference_engines)} engines)")
    # print(f"  ✓ Current: Engines 51-100 ({len(current_engines)} engines)")
    
    print(f"  ✓ Reference: Engines 1-100 ({len(reference_engines)} engines)")
    print(f"  ✓ Current: Engines 1-100 ({len(current_engines)} engines)")
